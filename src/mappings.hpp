...
namespace Romox::Maps
{
    ...
    const std::unordered_map<uint8_t, std::string> licensee_codes{
        {0x00, "None"},
        {0x01, "Nintendo"},
        {0x08, "Capcom"},
        {0x09, "Hot-B"},
        ...
        {0x31, "Nintendo"},
        {0x32, "Bandai"},
        {0x33, "Indicates that the New licensee code</a> should be used instead."},
        {0x34, "Konami"},
        {0x35, "HectorSoft"},
        {0x38, "Capcom"},
        {0x39, "Banpresto"},
    ...
    const std::unordered_map<std::string, std::string> new_licensee_codes{
        {"00", "None"},
        {"01", "Nintendo R&D1"},
        {"08", "Capcom"},
        {"13", "Electronic Arts"},
